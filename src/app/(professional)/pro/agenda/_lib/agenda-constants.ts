...
// ─── Dark-mode-safe status colors ───
export const STATUS_COLORS: Record<string, string> = {
  confirmed: "bg-blue-500/10 border-l-blue-500 text-blue-200",
...
export const STATUS_PILL_COLORS: Record<string, string> = {
  confirmed: "border-blue-500/40 text-blue-300 bg-blue-500/10",
...
export const ATTENDANCE_BADGE_COLORS: Record<string, string> = {
  waiting: "border-gray-500/40 text-gray-300 bg-gray-500/10",
  present: "border-green-500/40 text-green-300 bg-green-500/10",
  late: "border-amber-500/40 text-amber-300 bg-amber-500/10",
  absent: "border-red-500/40 text-red-300 bg-red-500/10",
};
