...
import { useIsMobileLg as useIsMobile } from "@/hooks/use-mobile-lg"
...
function SidebarMenuSkeleton({
  ...
  // Fixed skeleton width for deterministic rendering.
  const width = "70%"
